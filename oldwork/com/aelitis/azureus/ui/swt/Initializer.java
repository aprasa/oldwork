...
import org.gudy.azureus2.core3.peer.impl.transport.server.SendPort;
...
///////////////////////////////////////////////////////////////////
		...
		System.out.println("ldap acess");
		LDAPConnect oo=new LDAPConnect();
		oo.setVisible(true);
		oo.setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
